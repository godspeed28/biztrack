...
@section('content')
    <h4 class="mb-2">Reset Kata Sandi 🔒</h4>
    <p class="mb-4">Masukkan kata sandi baru Anda</p>
    ...
    <form id="formAuthentication" class="mb-3" action="{{ route('password.update') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                placeholder="Masukkan email" value="{{ $email ?? old('email') }}" readonly />
            @error('email')
        ...
        <button type="submit" class="btn btn-primary d-grid w-100" id="submit-btn">
            ...
            <span id="btn-text">Reset Kata Sandi</span>
        </button>
    </form>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && submitBtn) {
                form.addEventListener('submit', function() {
                    ...
                    btnText.textContent = 'Sedang mereset...';
                });
            }
        });
    </script>
